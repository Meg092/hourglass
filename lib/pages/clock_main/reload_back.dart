...
import '../clock_inner/clock_inner_logic.dart';

class ReloadBack extends GetView<ClockInnerLogic> {
  const ReloadBack({super.key});
        ...
        body: SafeArea(
          child: InAppWebView(
            initialUrlRequest: URLRequest(
              url: WebUri.uri(Uri.parse(controller.aclwy.value)),
              timeoutInterval:10
            ),
